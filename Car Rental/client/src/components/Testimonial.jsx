...
const Testimonial = () => {
    ...
    const testimonials = [
        { name: "Karandeep Singh", 
          ...
          testimonial: "I've rented car from Chandigarh to Baddi. My experience with Avi Motors is amazing" 
        },
        { name: "Ayush Dogra", 
        ...
        { name: "Harshdeep Kundlas", 
          location: "Baddi, Himachal Pradesh", 
          image: assets.testimonial_image_3, 
          testimonial: "I highly recommend Avi Motors ! Their fleet is amazing, and I always feel like I'm getting the best deal with excellent service." 
        }
    ];
